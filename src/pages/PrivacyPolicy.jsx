  ...
  return (
    <PageTransition>
      ...
      <PolicyLayout title="Privacy Policy" updated="July 2026">
        ...
        <p>We collect information you provide directly, such as your name, email, shipping address and payment details when you place an order, create an account, or contact our concierge team. We also collect usage data such as pages visited and items viewed, to improve your experience.</p>
        ...
        <h2>Your Rights</h2>
        <p>You may request access to, correction of, or deletion of your personal data at any time by emailing privacy@zivora.com. We will respond within 30 days.</p>

        <h2>Data Security</h2>
        <p>We use industry-standard encryption and access controls to protect your information. No online system is completely secure, but we continuously review our practices to minimise risk.</p>

        <h2>Contact Us</h2>
        <p>Questions about this policy can be sent to privacy@zivora.com or our boutique address listed on the Contact page.</p>
      </PolicyLayout>
    </PageTransition>
  )
}
