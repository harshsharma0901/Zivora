    ...
    <section className="relative min-h-screen flex items-center bg-beige overflow-hidden">
      <div className="absolute inset-0">
        <img
          ...
          alt="ZIVORA signature jewellery piece catching the light"
      ...
      <div className="container-x relative z-10">
        <div className="max-w-xl">
          ...
          <h1 className="facet-reveal font-display text-5xl md:text-7xl leading-[1.05] text-ink" style={{ animationDelay: '0.15s' }}>
            Shine Beyond
            <br />
            Ordinary
          </h1>
          ...
          <motion.p
            className="text-ink/60 text-base md:text-lg mt-6 max-w-md leading-relaxed"
          ...
          >
            <Link to="/shop" className="glint bg-ink text-white px-8 py-4 eyebrow !text-[0.7rem] hover:bg-rosegold transition-colors">
              Shop the Edit
            </Link>
            <Link to="/collections" className="border border-ink/30 px-8 py-4 eyebrow !text-[0.7rem] text-ink hover:border-rosegold hover:text-rosegold transition-colors">
              View Collections
            </Link>
          </motion.div>
        </div>
    ...
    <section className="py-24 bg-beige">
      <div className="container-x">
        ...
        <div className="text-center mt-14">
          <Link to="/shop" className="eyebrow border-b border-ink/30 pb-1 hover:border-rosegold hover:text-rosegold transition-colors">
            View All Jewellery
          </Link>
        </div>
      </div>
